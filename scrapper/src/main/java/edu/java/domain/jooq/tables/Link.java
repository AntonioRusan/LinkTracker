...
import edu.java.domain.jooq.tables.StackoverflowLink.StackoverflowLinkPath;
...
public class Link extends TableImpl<LinkRecord> {
    ...
    private transient StackoverflowLinkPath _stackoverflowLink;

    /**
     * Get the implicit to-many join path to the
     * <code>PUBLIC.STACKOVERFLOW_LINK</code> table
     */
    public StackoverflowLinkPath stackoverflowLink() {
        if (_stackoverflowLink == null)
            _stackoverflowLink = new StackoverflowLinkPath(this, null, Keys.CONSTRAINT_9.getInverseKey());

        return _stackoverflowLink;
    }
